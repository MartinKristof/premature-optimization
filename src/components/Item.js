...
const squareRoot = num => (Math.round(Math.sqrt(parseInt(num, 10)) * 100) / 100).toFixed(2);

export const MemoizedItem = memo(({ value, id, onRemove }) => {
...
export const Item = ({ value, id, onRemove }) => {
